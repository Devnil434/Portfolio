    ...
    return (
        <section className="pt-5 pb-14">
            <div className="container" ref={containerRef}>
                ...
                <div
                    className="fade-in-later relative flex flex-col gap-16 max-w-[1400px] mx-auto mt-20"
                    id="images"
                >
                    {project.images.map((image) => (
                        <div
                            key={image}
                            className="group relative w-full bg-background-light rounded-[2rem] overflow-hidden mac-border glass shadow-2xl"
                        >
                            <img
                                src={image}
                                alt="Project detail"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer noopener"
                                className="absolute top-8 right-8 bg-background/60 backdrop-blur-xl text-foreground size-16 inline-flex justify-center items-center transition-all opacity-0 hover:bg-primary hover:text-primary-foreground group-hover:opacity-100 rounded-2xl z-[1] border border-white/10"
                            >

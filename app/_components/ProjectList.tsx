            ...
            <div className="container">
                ...
                <div className="group/projects relative" ref={containerRef}>
                    {selectedProject !== null && (
                        <div
                            className="max-md:hidden absolute right-0 top-0 z-[10] pointer-events-none w-[300px] xl:w-[500px] opacity-0 rounded-2xl overflow-hidden glass mac-border shadow-2xl"
                            ref={imageContainer}
                        >
                            {PROJECTS.map((project) => (
                                <Image
                                    ...
                                    height="900"
                                    className={cn(
                                        'relative transition-all duration-500 w-full h-auto object-contain bg-background/50',
                                        {
                                            'opacity-0 hidden':
                                                project.slug !==
                                                selectedProject,
